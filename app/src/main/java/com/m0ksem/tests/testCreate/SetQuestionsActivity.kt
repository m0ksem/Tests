...
class SetQuestionsActivity : AppCompatActivity()  {

    private lateinit var adapter: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter
    ...
    inner class QuestionsAdapter(val questions: ArrayList<Test.Question>) : RecyclerView.Adapter<com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, p1: Int): com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.ViewHolder {
        ...
        fun addAnswer(position: Int , answer: String) {
            when (type) {
                "answers_with_score" -> questions[position].answers.add(ScoreTest.Question.Answer(answer, 0f))
                "answers_with_string" -> questions[position].answers.add(StringTest.Question.Answer(answer, ""))
        ...
        override fun onBindViewHolder(view: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        inner class AnswersWithStringAdapter(val answers: ArrayList<StringTest.Question.Answer>) : RecyclerView.Adapter<com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithStringAdapter.ViewHolder>() {
            override fun onCreateViewHolder(parent: ViewGroup, p1: Int): com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithStringAdapter.ViewHolder {
                return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.create_test_answer_with_string, parent, false))
            }

            override fun onBindViewHolder(view: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithStringAdapter.ViewHolder, position: Int) {
        ...
        inner class AnswersWithScoreAdapter(val answers: ArrayList<ScoreTest.Question.Answer>) : RecyclerView.Adapter<com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithScoreAdapter.ViewHolder>() {
            override fun onCreateViewHolder(parent: ViewGroup, p1: Int): com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithScoreAdapter.ViewHolder {
                return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.create_test_answer_with_value, parent, false))
            }

            override fun onBindViewHolder(view: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithScoreAdapter.ViewHolder, position: Int) {
                view.answerText.text = answers[position].text
        ...
        inner class AnswersWithConnectionAdapter(val answers: ArrayList<NeuroTest.Question.Answer>) : RecyclerView.Adapter<com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ViewHolder>() {
            override fun onCreateViewHolder(parent: ViewGroup, p1: Int): com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ViewHolder {
                return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.create_test_answer_with_connection, parent, false))
            }

            override fun onBindViewHolder(view: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ViewHolder, position: Int) {
                view.answerText.text = answers[position].text
            ...
            inner class ConnectionAdapter(val connections: ArrayList<NeuroTest.Connection>) : RecyclerView.Adapter<com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ConnectionAdapter.ViewHolder>() {
                override fun onCreateViewHolder(parent: ViewGroup, p1: Int): com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ConnectionAdapter.ViewHolder {
                ...
                override fun onBindViewHolder(view: com.m0ksem.tests.testCreate.SetQuestionsActivity.QuestionsAdapter.AnswersWithConnectionAdapter.ConnectionAdapter.ViewHolder, position: Int) {
